...
I'm using this to learn the things I need for a DevOps role — Linux, Docker, Kubernetes, Terraform. Everything is set up manually using official documentation.
